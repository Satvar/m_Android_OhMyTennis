...
import com.tech.cloudnausor.ohmytennis.Calenderpackage.utils.CalendarUtils;

import java.util.ArrayList;
import java.util.Calendar;
import java.util.List;

import static com.tech.cloudnausor.ohmytennis.Calenderpackage.MonthIndex.FOCUSED_MONTH;
import static com.tech.cloudnausor.ohmytennis.Calenderpackage.MonthIndex.NEXT_MONTH;
import static com.tech.cloudnausor.ohmytennis.Calenderpackage.MonthIndex.PREVIOUS_MONTH;
...
class MonthPager {
    ...
    private void loadEventsForMonth(CalendarMonth calendarMonth) {
        ...
        List<? extends CalendarEvent> monthEvents = mOnLoadEventsListener.onLoadEvents(calendarMonth.getYear(), calendarMonth.getMonth());

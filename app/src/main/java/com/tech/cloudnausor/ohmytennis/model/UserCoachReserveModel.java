...
public class UserCoachReserveModel {
    ...
    public UserCoachReserveModel(String reservationHeading, String reserveName, String reserveredDate, String reserveredTime, String reserveStatus) {

...
//                }
    ...
    public class CoachUserReservationAdapterHolder extends RecyclerView.ViewHolder {
        ...
        LinearLayout Discout_layout,layout_stage;
        ...
        public CoachUserReservationAdapterHolder(@NonNull View itemView) {
            ...
            Reserve_Modify.setOnClickListener(new View.OnClickListener() {
                ...
                public void onClick(View view) {
                    ...
                    Intent intent = new Intent(context, NewpaymentStripe.class);
                    intent.putExtra("bookvalue", coachUserReserveModelArrayList.get(getAdapterPosition()).getBooking_Id());
...
//                    alertDialog.show();
            ...
            Dialog_set_status.setOnClickListener(new View.OnClickListener() {
                ...
                public void onClick(View view) {
                    ...
                    apiInterface.cancelreservation( coachUserReserveModelArrayList.get(getAdapterPosition()).getCoach_ID(),status,coachUserReserveModelArrayList.get(getAdapterPosition()).getBooking_Id(),
                            coachUserReserveModelArrayList.get(getAdapterPosition()).getBookingDate(),pricess,
                            coachUserReserveModelArrayList.get(getAdapterPosition()).getBookingCourse(), dis,coachUserReserveModelArrayList.get(getAdapterPosition()).getEmail()).enqueue(new Callback<BookingRequestStatusResponse>() {
                        @Override
                        public void onResponse(@NonNull Call<BookingRequestStatusResponse> call, @NonNull Response<BookingRequestStatusResponse> response) {
                            ...
                            if(response.body().getIsSuccess().equals("true")){
                                ...
                                Toast.makeText(context,response.body().getMessage(),Toast.LENGTH_LONG).show();
                                alertDialog.dismiss();
                                ((NewHomePage)context).setLastPosition(Constant.MENU_RESERVATION);
//                                ((NewHomePage)context).setLastPosition(Constant.MENU_RESERVATION);
                            }else {
                                singleTonProcess.dismiss();
                                Toast.makeText(context,response.body().getMessage(),Toast.LENGTH_LONG).show();

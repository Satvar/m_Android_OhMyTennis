...
public class StageDTO {
    ...
    public class StageData {
        ...
        @Expose
        ArrayList<StageCourse> event_list = new ArrayList<StageCourse>();
        ...
        public ArrayList<StageCourse> getEvent_list() {
            return event_list;
        }

        public void setEvent_list(ArrayList<StageCourse> event_list) {

...
import com.tech.cloudnausor.ohmytennis.Calenderpackage.CalendarView;
import com.tech.cloudnausor.ohmytennis.Calenderpackage.OnDateSelectedListener;
import com.tech.cloudnausor.ohmytennis.Calenderpackage.OnLoadEventsListener;
import com.tech.cloudnausor.ohmytennis.Calenderpackage.OnMonthChangedListener;
...
public class BasicActivity extends AppCompatActivity implements OnMonthChangedListener,
    ...
    private static final String PREFER_NAME = "RegUser";
...
//        }
    ...
    public void onBackPressed() {
        super.onBackPressed();
        Intent intent = new Intent(BasicActivity.this, IndividualCourseHomeActivity.class);
